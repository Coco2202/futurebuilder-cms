...
export interface ApiContentItemContentItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    accessLevel: Schema.Attribute.Enumeration<['public', 'organization_only']> &
      Schema.Attribute.Required &
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    scope: Schema.Attribute.Enumeration<['core', 'swst', 'swsc']> &
      Schema.Attribute.Required;
    ...
    type: Schema.Attribute.Enumeration<['video', 'podcast', 'pdf']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiOrganizationOrganization
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    hasCoreAccess: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::organization.organization'
    ...
    tool_pages: Schema.Attribute.Relation<
      'oneToMany',
      'api::tool-page.tool-page'
    >;
    topics: Schema.Attribute.Relation<'oneToMany', 'api::topic.topic'>;
    type: Schema.Attribute.Enumeration<
      ['core', 'company', 'partner', 'community']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiToolPageToolPage extends Struct.CollectionTypeSchema {
  collectionName: 'tool_pages';
  info: {
    displayName: 'tool-page';
    pluralName: 'tool-pages';
    singularName: 'tool-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    detailText: Schema.Attribute.Text;
    ...
    slug: Schema.Attribute.UID<'toolName'> & Schema.Attribute.Required;
    tags: Schema.Attribute.JSON;
    toolName: Schema.Attribute.String & Schema.Attribute.Required;
    tutorialUrl: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::tool-page.tool-page': ApiToolPageToolPage;
